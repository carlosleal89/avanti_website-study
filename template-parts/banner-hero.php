...
<div class="banner-hero-content z-1 relative flex flex-col justify-center items-center h-[calc(100vh-theme(space.28))]">
  <h1 class="font-bold text-2xl md:text-5xl text-center">Complete for <span class="text-royalblue">commerce</span></h1>
  <p class="text-center text-grayishblue pt-6">Impulsione o e-commerce da sua empresa com soluções<br>integradas, performance e experiência.</p>
  ...
  <div class="slider-icons-container pt-[100px] w-[80%] h-[200px]">
